...
const reviews = [
  { name: "Ravi K.", role: "Wholesale distributor, KR Market", text: "KarnaTrans has been moving our stock daily for two years. Not one late delivery. Their drivers are polite and careful." },
  { name: "Priya S.", role: "Ops manager, Peenya factory", text: "We switched to their contract fleet and cut logistics cost by 20%. Booking is just one phone call now." },
  { name: "Anand M.", role: "Retail chain owner, Mysuru", text: "Whether it's a Tata ACE for a single crate or a Canter across the state, they handle it. Fair pricing, no hidden fees." },
];
  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <h2 className="section-title">Trusted by businesses across Karnataka</h2>
...
const faqs = [
  { q: "Which areas do you serve?", a: "We operate all across Karnataka — Bengaluru city and every district. Regular routes cover Mysuru, Mangaluru, Hubballi, Belagavi and more." },
